...
//       x: rect.left + rect.width / 2 - 75,  // Center horizontally
//       y: rect.bottom + window.scrollY + 8,
//     });

//     // Toggle visibility: if already open, close; if closed, open
...
//           {hover && (
//             <div
//               className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white transition-all duration-200"
//               onClick={(e)=> showContextMenu(e)} id="context-opener"
//             >
//               <FaCamera className="text-2xl mb-1" onClick={(e)=> showContextMenu(e)} id="context-opener" />
//               <span className="text-sm" onClick={(e)=> showContextMenu(e)} id="context-opener">Change your profile</span>
//             </div>
//           )}
//         </div>
//       )}
...
//         />
//       )}
//       {showCapturePhoto && <CapturePhoto setProfileImage={setProfileImage} hide ={setShowCapturePhoto}/>}
//       {showPhotoLibrary && (<PhotoLibrary setProfileImage={setProfileImage} hidePhotoLibrary={setShowPhotoLibrary}/>)}
